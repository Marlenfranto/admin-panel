...
Future<void> showOrgTheoryChapterLocalizationsSheet({
  required BuildContext context,
  ...
  return _showLocalizationSheet(
    ...
    body: _OrgTheoryChapterLocalizationsBody(
      chapterId: chapterId,
...
class _OrgQuizQuestionState {
  _OrgQuizQuestionState(int answerCount)
...
class _OrgTheoryChapterLocalizationsBody extends ConsumerStatefulWidget {
  const _OrgTheoryChapterLocalizationsBody({
  ...
  @override
  ConsumerState<_OrgTheoryChapterLocalizationsBody> createState() =>
      _OrgTheoryChapterLocalizationsBodyState();
}
...
class _OrgTheoryChapterLocalizationsBodyState
  ...
  late List<_OrgQuizQuestionState> _quizStates;
  ...
  void initState() {
    ...
    _quizStates = widget.questions
        .map((q) => _OrgQuizQuestionState(q.answers.length))
        .toList();
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final saved = await ref
          .read(clientProvider)
          .organizationAdmin
          .upsertMyTheoryChapterLocalization(widget.chapterId, loc);
      _current = saved;
  ...
  Future<void> _delete() async {
    ...
    try {
      await ref
          .read(clientProvider)
          .organizationAdmin
          .deleteMyTheoryChapterLocalization(_current!.id!);
      ref.invalidate(
          orgTheoryChapterLocalizationsProvider(widget.chapterId));
  ...
  Widget build(BuildContext context) {
    final localesAsync = ref.watch(orgLocaleConfigsProvider);
    final existingAsync =
        ref.watch(orgTheoryChapterLocalizationsProvider(widget.chapterId));
    final cfgAsync = ref.watch(orgModuleConfigProvider);
...
class _OrgQuizQuestionEditor extends StatelessWidget {
  const _OrgQuizQuestionEditor({
    required this.index,
  ...
  final _OrgQuizQuestionState state;
...
Future<void> showOrgTrainingParameterLocalizationsSheet({
  required BuildContext context,
  ...
  return _showLocalizationSheet(
    context: context,
    title: 'Localizations — $parentLabel',
    body: _OrgTrainingParameterLocalizationsBody(
...
class _OrgTrainingParameterLocalizationsBody extends ConsumerStatefulWidget {
  const _OrgTrainingParameterLocalizationsBody({
  ...
  @override
  ConsumerState<_OrgTrainingParameterLocalizationsBody> createState() =>
      _OrgTrainingParameterLocalizationsBodyState();
}
...
class _OrgTrainingParameterLocalizationsBodyState
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final saved = await ref
          .read(clientProvider)
          .organizationAdmin
          .upsertMyTrainingParameterLocalization(widget.parameterId, loc);
      _current = saved;
      ref.invalidate(orgTrainingParameterLocalizationsProvider(
          widget.parameterId));
      if (mounted) _snackOk('Saved $_selectedLocaleKey');
    } catch (e) {
      if (mounted) _snackError(e);
  ...
  Future<void> _delete() async {
    ...
    try {
      await ref
          .read(clientProvider)
          .organizationAdmin
          .deleteMyTrainingParameterLocalization(_current!.id!);
      ref.invalidate(orgTrainingParameterLocalizationsProvider(
          widget.parameterId));
      setState(() => _loadInto(null));
      if (mounted) _snackOk('Deleted $_selectedLocaleKey');
  ...
  Widget build(BuildContext context) {
    ...
    final existingAsync = ref
        .watch(orgTrainingParameterLocalizationsProvider(widget.parameterId));
    final cfgAsync = ref.watch(orgModuleConfigProvider);
...
Future<void> showOrgAssessmentParameterLocalizationsSheet({
  required BuildContext context,
  required int parameterId,
  required String parentLabel,
  required int feedbackCount,
  ...
  return _showLocalizationSheet(
    context: context,
    title: 'Localizations — $parentLabel',
    body: _OrgAssessmentParameterLocalizationsBody(
      parameterId: parameterId,
      parentLabel: parentLabel,
      feedbackCount: feedbackCount,
    ),
...
class _OrgAssessmentParameterLocalizationsBody extends ConsumerStatefulWidget {
  const _OrgAssessmentParameterLocalizationsBody({
    required this.parameterId,
    required this.parentLabel,
    required this.feedbackCount,
  });
  ...
  @override
  ConsumerState<_OrgAssessmentParameterLocalizationsBody> createState() =>
      _OrgAssessmentParameterLocalizationsBodyState();
}
...
class _OrgAssessmentParameterLocalizationsBodyState
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final saved = await ref
          .read(clientProvider)
          .organizationAdmin
          .upsertMyAssessmentParameterLocalization(widget.parameterId, loc);
      _current = saved;
      ref.invalidate(orgAssessmentParameterLocalizationsProvider(
          widget.parameterId));
      if (mounted) _snackOk('Saved $_selectedLocaleKey');
    } catch (e) {
      if (mounted) _snackError(e);
  ...
  Future<void> _delete() async {
    ...
    try {
      await ref
          .read(clientProvider)
          .organizationAdmin
          .deleteMyAssessmentParameterLocalization(_current!.id!);
      ref.invalidate(orgAssessmentParameterLocalizationsProvider(
          widget.parameterId));
      setState(() => _loadInto(null));
      if (mounted) _snackOk('Deleted $_selectedLocaleKey');
  ...
  Widget build(BuildContext context) {
    ...
    final existingAsync = ref.watch(
        orgAssessmentParameterLocalizationsProvider(widget.parameterId));
    final cfgAsync = ref.watch(orgModuleConfigProvider);
