...
-- Indexes
CREATE UNIQUE INDEX "manager_notification_unique_idx" ON "manager_notification" USING btree ("managerId", "overdueUserId", "moduleId", "teamId");
...
-- Indexes
CREATE UNIQUE INDEX "user_module_progress_unique_idx" ON "user_module_progress" USING btree ("appUserId", "moduleId", "organizationId", "teamId");
...
--
-- Foreign relations for "manager_notification" table
--
