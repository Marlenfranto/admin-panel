...
--
-- Class AssessmentParameterLocalization as table assessment_parameter_localization
--
...
--
-- Class AssetLocalization as table asset_localization
--
...
--
-- Class LocaleConfig as table locale_config
--
...
CREATE TABLE "module_config" (
    ...
    "defaultLocaleKey" text NOT NULL DEFAULT 'US-en'::text,
    "supportedLanguages" json,
    "aiChatPrompt" text,
    "aiChatPromptTranslations" json,
...
--
-- Class TheoryChapterLocalization as table theory_chapter_localization
--
...
--
-- Class TrainingParameterLocalization as table training_parameter_localization
--
...
--
-- Class TrainingSessionResult as table training_session_result
--
...
--
-- Class UserTheoryProgress as table user_theory_progress
--
...
--
-- Foreign relations for "assessment_parameter_localization" table
--
...
--
-- Foreign relations for "asset_localization" table
--
...
--
-- Foreign relations for "locale_config" table
--
...
--
-- Foreign relations for "region" table
--
...
--
-- Foreign relations for "theory_chapter_localization" table
--
...
--
-- Foreign relations for "training_parameter_localization" table
--
...
--
-- Foreign relations for "training_session_result" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('admin_panel', '20260528100629908', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260528100629908', "timestamp" = now();
