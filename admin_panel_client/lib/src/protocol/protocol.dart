...
import 'localized_ai_prompt.dart' as _i8;
import 'localized_parameter_content.dart' as _i9;
...
import 'package:admin_panel_client/src/protocol/organization.dart' as _i37;
import 'package:admin_panel_client/src/protocol/app_user.dart' as _i38;
...
import 'package:admin_panel_client/src/protocol/localized_ai_prompt.dart'
    as _i40;
import 'package:admin_panel_client/src/protocol/theory_chapter.dart' as _i41;
...
import 'package:admin_panel_client/src/protocol/assessment_parameter.dart'
    as _i43;
import 'package:admin_panel_client/src/protocol/asset.dart' as _i44;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.LocalizedAiPrompt) {
      return _i8.LocalizedAiPrompt.fromJson(data) as T;
    }
    if (t == _i9.LocalizedParameterContent) {
      return _i9.LocalizedParameterContent.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.LocalizedAiPrompt?>()) {
      return (data != null ? _i8.LocalizedAiPrompt.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.LocalizedParameterContent?>()) {
      return (data != null
              ? _i9.LocalizedParameterContent.fromJson(data)
              : null)
          as T;
    }
    ...
    if (t == List<_i9.LocalizedParameterContent>) {
      return (data as List)
              .map((e) => deserialize<_i9.LocalizedParameterContent>(e))
              .toList()
          as T;
    }
    if (t == _i1.getType<List<_i9.LocalizedParameterContent>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i9.LocalizedParameterContent>(e))
                    .toList()
    ...
    if (t == List<_i8.LocalizedAiPrompt>) {
      return (data as List)
              .map((e) => deserialize<_i8.LocalizedAiPrompt>(e))
              .toList()
          as T;
    }
    if (t == _i1.getType<List<_i8.LocalizedAiPrompt>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i8.LocalizedAiPrompt>(e))
                    .toList()
    ...
    if (t == List<_i40.LocalizedAiPrompt>) {
      return (data as List)
              .map((e) => deserialize<_i40.LocalizedAiPrompt>(e))
              .toList()
          as T;
    }
    if (t == _i1.getType<List<_i40.LocalizedAiPrompt>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i40.LocalizedAiPrompt>(e))
                    .toList()
    ...
    if (t == List<_i41.TheoryChapter>) {
      return (data as List)
              .map((e) => deserialize<_i41.TheoryChapter>(e))
              .toList()
          as T;
    }
    if (t == List<_i42.TrainingParameter>) {
      return (data as List)
              .map((e) => deserialize<_i42.TrainingParameter>(e))
              .toList()
          as T;
    }
    if (t == List<_i43.AssessmentParameter>) {
      return (data as List)
              .map((e) => deserialize<_i43.AssessmentParameter>(e))
              .toList()
          as T;
    }
    if (t == List<_i44.Asset>) {
      return (data as List).map((e) => deserialize<_i44.Asset>(e)).toList()
          as T;
    }
    if (t == List<_i45.UserModuleProgress>) {
      return (data as List)
              .map((e) => deserialize<_i45.UserModuleProgress>(e))
              .toList()
          as T;
    }
    if (t == List<_i46.TrainingSessionResult>) {
      return (data as List)
              .map((e) => deserialize<_i46.TrainingSessionResult>(e))
              .toList()
          as T;
    }
    if (t == List<_i47.ManagerNotificationDetail>) {
      return (data as List)
              .map((e) => deserialize<_i47.ManagerNotificationDetail>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i48.TrainingCriteriaScore>) {
      return (data as List)
              .map((e) => deserialize<_i48.TrainingCriteriaScore>(e))
              .toList()
          as T;
    }
    if (t == List<_i49.TheoryChapterWithProgress>) {
      return (data as List)
              .map((e) => deserialize<_i49.TheoryChapterWithProgress>(e))
              .toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i8.LocalizedAiPrompt => 'LocalizedAiPrompt',
      _i9.LocalizedParameterContent => 'LocalizedParameterContent',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i8.LocalizedAiPrompt():
        return 'LocalizedAiPrompt';
      case _i9.LocalizedParameterContent():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'LocalizedAiPrompt') {
      return deserialize<_i8.LocalizedAiPrompt>(data['data']);
    }
    if (dataClassName == 'LocalizedParameterContent') {
      return deserialize<_i9.LocalizedParameterContent>(data['data']);
    }
